...
ButtonMatrix Layout::colorSelector =
  ButtonMatrix::create().setPosition(0, 0).setSize(screenWidth, (screenHeight - 40) / 3);

ButtonMatrix Layout::autonSelector = ButtonMatrix::create()
                                       .setPosition(0, (screenHeight - 40) / 3)
                                       .setSize(screenWidth, (screenHeight - 40) * 2 / 3);
...
lv_res_t Layout::colorSelectorAction(lv_obj_t* btnm, const char* txt) {
  ...
  colorSelector.setStyle(LV_BTNM_STYLE_BG, style)
